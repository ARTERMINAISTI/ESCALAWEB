<?php
    ...
    class Viagem {
        ...
        private $numero;
        private $filial;
        private $filialDestino;
        private $filialOrigem;
        private $status;
        private $statusNome;
        private $connect;
        ...
        //-- Pega as Filiais de origem e destino da Viagem;
        ...
        public function getListaTipoOcorrencia(){
            $query = $this->connect->prepare("SELECT A.HANDLE, A.NOME, A.ACAO 
                                                ...
                                                SELECT A.HANDLE, A.NOME, A.ACAO 
                                                
                                                FROM OP_TIPOOCORRENCIA A  
                                                    
                                                WHERE (A.ACAO IN (3, 11,37,7,18,13,2,15,4,27,29,11,37,13,16,28,30,38, 41))
                                                AND (EHPERMITEMANUAL = 'S')
                                                AND (A.EHDISPONIVELAPP = 'S')
                                                AND (A.STATUS = 3)");
            $query->execute();
