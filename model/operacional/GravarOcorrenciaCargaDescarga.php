...
$motivoOcorrenciaHandle = Sistema::getPost('motivoOcorrenciaHandle');
$anexos = Sistema::getPost('anexos');
...
if(!empty($motivoOcorrenciaHandle)){
    $arr["cargaDescarga"]["motivoOcorrencia"] = $motivoOcorrenciaHandle;
}
$arr["cargaDescarga"]["transportadora"] = $transportadora;
if ($anexos != ''){
    $arr["cargaDescarga"]["anexos"] = 'S';
} else {
    $arr["cargaDescarga"]["anexos"] = 'N';
}
