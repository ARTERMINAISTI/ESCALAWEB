            ...
            <div>
                ...
                <div class="modal-body row">
                    ...
                    <div class="col-sm-12 pullBottom">
                        <span>Motivo</span>
                        <div class="inner-addon right-addon"> <font size="-2"><i class="glyphicon glyphicon-triangle-bottom" id="spandown"></i></font>
                            <input type="text" name="motivoOcorrencia" id="motivoOcorrencia" onfocus="motivoOnPesquisar()" onClick="clickdownMotivoOcorrencia();" class="editou form-control pulaCampoEnter">
                        </div>
                        <input type="text" name="motivoOcorrenciaHandle" id="motivoOcorrenciaHandle" hidden="true">
                    </div>
