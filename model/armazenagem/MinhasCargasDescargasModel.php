...
class minhasCargasDescargasModel {
    ...
    protected function setstatusImagem($ProgramacaoStatus, $ProgramacaoStatusNome ) {
        ...
        if ($ProgramacaoStatus == '6') {
            $this->statusImagem = "<img src='../../view/tecnologia/img/status/verde/verificado.png' width='13px' height='auto' title='" . $ProgramacaoStatusNome . "' alt='" . $ProgramacaoStatusNome . "'>";
        }
