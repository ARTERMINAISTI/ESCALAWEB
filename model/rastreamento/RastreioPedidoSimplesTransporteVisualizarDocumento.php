    ...
    <div>
            ...
            ?>
                ...
                <tr style="background-color: #FFFFF5;font-size:13px">        
                    <td style="padding-left: 20pt; border: 0; width: 15%"><label><?php echo $tipoDocumentoOriginario; ?> </label> <?php echo $numeroDocumentoOriginario; ?> - <?php echo $serieDocumentoOriginario; ?></td>            
                    <td style="border: 0;"><label>Emissão:</label> <?php echo $dataEmissaoRastreamentoDocumento; ?></td>
