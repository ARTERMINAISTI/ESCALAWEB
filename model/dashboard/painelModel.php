        ...
        <div class="carousel-inner" role="listbox">
            ...
            while ($rowPainel = $queryPainel->fetch(PDO::FETCH_ASSOC)) {
                ...
                $queryPainelComponente = $connect->prepare("SELECT  A.HANDLE,
						   ...
						   FROM BI_PAINELCOMPONENTE A0
						   INNER JOIN BI_COMPONENTE A ON A.HANDLE = A0.COMPONENTE
				  LEFT JOIN BI_TIPOCOMPONENTE B ON A.TIPO = B.HANDLE 
				  			   INNER JOIN BI_PAINEL C ON C.HANDLE = A.PAINEL
				  FULL JOIN MS_VARIAVEL D ON D.HANDLE = 0
WHERE A0.PAINEL = 7				  
ORDER BY  A0.PAINEL, A0.POSICAOX, A0.POSICAOY ASC
							 ");
                //AND A.EHUTILIZADO = 'S'
