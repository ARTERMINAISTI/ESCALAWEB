...
function adicionarOnClickConsulta(){// alterado para funcionar com o touch no mobile, https://stackoverflow.com/questions/27560653/jquery-on-double-click-event-dblclick-for-mobile
    var touchtime = 0;
    $("#tableEstoqueArmazem td").on("click", function() {
    if (touchtime == 0) {
        // set first click
...
function exportarOnHandler() {
    downloadCSV({ filename: "ResumoEstoqueArmazem.csv", stockData: retornoJson });
}
