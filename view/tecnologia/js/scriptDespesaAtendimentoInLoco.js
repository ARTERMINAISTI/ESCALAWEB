    ...
    $.getJSON('../../controller/servicedesk/InserirAtendimentoInLocoRecuperaTipo.php', function (data) {
        ...
        $('#tipo').autocomplete({
            ...
            select: function (event, ui) {
                ...
                var EHALTERARREEMBOLSO = ui.item.EHALTERARREEMBOLSO;
                ...
                if (EHALTERARREEMBOLSO === 'S') {
                    $('#totalReembolso').removeAttr('disabled');
                }
                else {
                    $('#totalReembolso').attr('disabled', 'true');
                }
