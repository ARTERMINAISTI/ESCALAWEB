...
if ($cpf == $cpfCompara) {
	...
	$mail->Password = '#mailfalecom123'; // Senha do servidor SMTP (senha do email usado)
	$mail->Port = '587';
	...
	// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
	$mail->AddAddress($emailCadastro, 'Alteração de senha Escalasoft');
	...
	// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
	$assunto = 'Nova senha de acesso - Currículo Escalasoft';
	$mail->Subject  = utf8_decode($assunto); // Assunto da mensagem
	$corpo = '
	 	<h2>Nova senha de acesso - Currículo Escalasoft</h2>
		Olá!
		<br />
		...
		Senha: '.$senhaNova.'
		<br />
		Caso tenha qualquer tipo de dúvida, contate o setor administrativo da Escalasoft.
		<br />
		<br /><br />
		';
