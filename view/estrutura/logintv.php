...
if (isset($_GET['id']))
{
    ...
    if ($tv == 'PAINELERP') {
        $usuarioLogin = 'painel.erp';
        $senha = 'erp123';
    }

    if ($tv == 'PAINELWMS') {
        $usuarioLogin = 'painel.wms';
        $senha = 'wms123';
    }

    if ($tv == 'PAINELTMS') {
        $usuarioLogin = 'painel.tms';
        $senha = 'tms123';
    }
}
                    ...
                    <div class="login-body FlexItem">
                        ...
                        <form method="post" action="../../controller/estrutura/LoginControllerTV.php">
                            <div class="inner-addon left-addon pullBottomLogin">
                                ...
                                <input type="text"  name="usuario" value="<?php echo $usuarioLogin; ?>" id="usuario" class="form-control" placeholder="Usuário" required>
                            </div>
