...
<html>
    ...
    <body id="bodyFullScreen">
        <div class="main-content">
            ...
            ?>
            <div>
                <div class="main-page login-page-new-escalatalentos FlexContainer">
                ...
                <div class="main-page login-page-new-direita FlexContainer">
                    <img style="width: 70%; margin: 0px 0px -40px 55px;"src="../tecnologia/img/logoAzul.png" class="logologin" alt="Escalasoft tecnologia">
                    <br>
                    <div class="linha">
                        <span class="acesseConta">Acesse a sua conta</span>
                    </div>
