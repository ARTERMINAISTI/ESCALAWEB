...
<html>
    <head>
        ...
        <link href="../tecnologia/css/styleCustom.php" rel='stylesheet' type='text/css' />
            ...
            <div class="main-page">
                <div class="rastreioForm">
                    <div class="col-sm-3 centering-v" id="formRastreio">
                        ...
                        <div class="col-sm-3 centering-v text-center" style="width:100%; margin-top: 10%; position:relative">
                            <a href="RastreioPedidoBuscar.php" style="color: white; font-size: 14px;">Consulte pelo código de rastreamento</a>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <label>Prazo de entrega(d):</label> <?php echo $prazoEntrega; ?>
                    </div>
                    <div class="col-xs-6">
                        <label>Previsão de entrega:</label> <?php echo $dataEntregaAteRastreamento; ?>
                    </div>
                </div>
                <hr>
	...
	<script>
            ...
            $(function () {  
                let formRastreio = $("#FormRastreioPedidoBuscar");              
                $.ajax({
                    url: "../../controller/rastreamento/Pedido.php",
                    method: "POST",
                    dataType: "JSON",
                    data: {
                        "ACAO" : "getRastreamentoClienteFinal"
                    },
                    success: function (retorno) {    
                        if(retorno.CLIENTEFINAL == 'S') {
                            formRastreio.append('<input type="text" name="n" id="rastreamento" class="form-control" value="<?php echo $n; ?>" placeholder="Número do documento (NF-e, DI, Outros)" required><br>');
                            formRastreio.append('<input type="text" name="dest" id="DESTINATARIO" class="form-control" value="<?php echo $dest; ?>"  placeholder="Destinatario (CNPJ / CPF)" required><br>');                                      
                            formRastreio.append('<input type="submit" name="enviar" id="btnsubmit" class="btn btn-default" style="float: right; font-size: 15px; border-radius: 3px;" value="Enviar">');                            

                        } else {
                            appendDefaultInputForm(formRastreio);
                        }             
            ...
            function appendDefaultInputForm(prForm) {
                prForm.append('<input type="text" name="n" id="rastreamento" class="form-control" value="<?php echo $n; ?>" placeholder="Número do documento (NF-e, DI, Outros)" required><br>');
                prForm.append('<input type="text" name="rem" id="REMETENTE" class="form-control" value="<?php echo $rem; ?>"  placeholder="Remetente (CNPJ / CPF)" required><br>');
                prForm.append('<input type="text" name="dest" id="DESTINATARIO" class="form-control" value="<?php echo $dest; ?>"  placeholder="Destinatario (CNPJ / CPF)" required><br>');          
                prForm.append('<input type="submit" name="enviar" id="btnsubmit" class="btn btn-default" style="float: right; font-size: 15px; border-radius: 3px;" value="Enviar">');
            }       
