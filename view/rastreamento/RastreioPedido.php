            ...
            <div class="main-content">
                ...
                <div class="sticky-header header-section ">
                    ...
                    <div class="topBarRight">
                        ...
                        <button data-toggle="modal" class="botaoTop btn" title="Filtrar" onClick="multiselection();" data-target="#FiltroModal">
                                ...
                                <table id="reqtablenew" class="table table-striped table-bordered" cellspacing="0" style="width:100%">
                                    <thead>
                                        <tr class="Noactivetr">  
                                            ...
                                            <th style="min-width:90px;" class="text-center">Data rastreio</th>
                                            <th class="text-center">Tipo</th>
                                            <th style="min-width:65px;" class="text-center">Nr pedido</th>
                                            <th style="min-width:70px;" class="text-center">Nr controle</th>
                                            <th style="min-width:90px;" class="text-center">Nr nota fiscal</th>                                        
                                            <th style="min-width:95px;" class="text-center">Vlr mercadoria</th>                                        
                                            <th style="min-width:95px;" class="text-center">Doc transporte</th>                                        
                                            <th style="min-width:85px;" class="text-center">Data emissão</th>                                                                                                                        
                                            <th style="min-width:60px;" class="text-right">Peso real</th>
                                            <th style="min-width:80px;" class="text-right">Peso cubado</th>
                                            <th style="min-width:75px;" class="text-right">Qtd volume</th>
                                            <th style="min-width:65px;" class="text-right">Valor frete</th> 
                                            <th style="min-width:90px;" class="text-center">Prev. entrega</th> 
                                            <th style="min-width:100px;"class="text-left">Remetente</th>
                                            <th style="min-width:100px;">Origem</th>
                                            <th >UF</th>
                                            <th style="min-width:150px;">Destinatário</th>
                                            <th style="min-width:150px;">Destino</th>
                                            <th >UF</th>
                                            <th style="min-width:150px;">Etapa atual</th>
                                            <th style="min-width:150px;"class="text-center">Entrega</th>                                        
                                            <th style="min-width:90px;">Duração</th>
