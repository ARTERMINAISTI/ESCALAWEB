...
if (!isset($_SESSION['usuario']) and !isset($_SESSION['senha'])) {
    ...
    $sql = "SELECT A.NUMERO, 
             ...
             INNER JOIN OP_STATUSVIAGEM C ON C.HANDLE = A.STATUS
              ...
              LEFT JOIN OP_VIAGEMMANIFESTO I ON I.VIAGEM = A.HANDLE
			  LEFT JOIN GD_DOCUMENTOMANIFESTO J ON J.HANDLE = I.DOCUMENTOMANIFESTO AND J.STATUS = 3
			  LEFT JOIN GD_DOCUMENTO K ON K.HANDLE = J.DOCUMENTO
                ...
                <div class="pageContent">
                    <div class="container">
                        <form id="FormViagem">
                            ...
                            <div class="form-row" style="font-size:5px;">
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="input-group mb-3" style="padding-bottom: 15px;">    
                                        <input type="text" class="form-control" id="pesquisa" placeholder="Pesquisar itens">
                                    </div> 
                                </div>
                            </div>                                                 
                            <hr>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="btn-group pull-right" role="group">
                                        <button name="baixarItem" class="btn btn-success" type="button" id="baixarItem">Baixar</button>
                                    </div>       
                                    <div class="btn-group pull-right <?= $temMdfe ? "displayListItem" : "displayNone"; ?>" role="group" style="padding-right: 5px;">
                                        <button type="button" class="btn btn-info">MDF-e</button>
                                    </div>
