...
if (!isset($_SESSION['usuario']) and !isset($_SESSION['senha'])) {
    ...
    $podeIncluirOcorrencia = Sistema::getPodeInserirRegistro($connect, 'AM_CARREGAMENTOOCORRENCIA');
    ?>
    <!DOCTYPE HTML>
    <html>
    <head>
        ...
        <form method="post" action="#">
            ...
            <div class="footerFixed">
                ...
                <div class="col-xs-11">
                    <div class="right">
                        <?php 
                        if ($podeIncluirOcorrencia) {
                            
                            echo '<button type="button" class="botao display" id="OcorrenciaProgramacaoCargaDescarga" 
                                        onClick="OcorrenciaProgramacaoCargaDescargaFun()">Ocorrência
                                    </button>';}
                            else {
                            echo '<button type="button" class="botao display" id="OcorrenciaProgramacaoCargaDescarga" disabled = "True" style = "visibility: hidden"
                                        onClick="OcorrenciaProgramacaoCargaDescargaFun()">Ocorrência
                                    </button>';}
                        ?>
                        ...
                        &nbsp;
                        <button type="button" class="botao display" id="inserirAnexoCargaDescarga"
                                onClick="InserirAnexoCargaDescargaFun()">Anexo
                        </button>
                    </div>
                </div>
            </div><!-- end footer -->
