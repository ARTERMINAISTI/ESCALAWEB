    ...
    <div class="pageContent">
                    ...
                    <table id="tableEstoque" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tr>
                            ...
                            <th id="lastcol">Saldo Bloqueado</th>
                        </tr>
                        </thead>
                    </table>
        ...
        $(document).ready(function () {
            ...
            var tableAprovacoes = $('#tableEstoque').DataTable({
                ...
                "fnInitComplete": function(){
                    let HeadInner = $(".dataTables_scrollHeadInner")[0];
                    let HeadInnerWidth = parseInt(HeadInner.style.width.match(/\d/g).join(""));

                    let UltimaColuna = $("#lastcol");//.css('display', 'none');
                    let newWidth;
                    if (HeadInnerWidth < 1200){
                        newWidth = parseInt(HeadInnerWidth * 0.055);
                    }
                    else{
                        newWidth = parseInt(HeadInnerWidth * 0.06);
                    }
                    
                    UltimaColuna.removeAttr("style");
                    
                    UltimaColuna.attr('style', 'width:'+newWidth+'px !important;');
                    UltimaColuna.attr('width', newWidth+'px');
                },
				buttons: [
					{
                ...
                "columns": [{
                    ...
                    "render": function (data) {
                                if (data != ""){
                                    return '<img src="' + urlImages + data + "?nocache=<?php echo time(); ?>" + '" width="150px" id="img"/>';
                                }
