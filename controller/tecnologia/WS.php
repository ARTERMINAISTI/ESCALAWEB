...
class WebService
{
    ...
    static private $body;
    static private $httpcode;
    static private $url = 'http://localhost:8084/escalasoft/';
    ...
    static function setPostData($data, $type = null)
    {
        ...
        curl_setopt(
            ...
            CURLOPT_HTTPHEADER,
            array(
                "Application-Name: EscalaWeb",
				"Authorization: " . $_SESSION['auditoriaAcesso'],
                "Content-Type: $type",
    ...
    static function execute()
    {
        ...
        self::$httpcode = curl_getinfo(self::$curl,  CURLINFO_HTTP_CODE);            
